...
public class CriticasController {
    ...
    public List<Critica> buscarCriticasPorNombreUsuario(@PathVariable("idUsuario") Integer idUsuario) {
        return criticasService.buscarCriticasPorIdUsuario(idUsuario);
    }
